...
public class growUP : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (at.transform.GetChild(0).gameObject.transform.localScale.x>1.04f)
        {
        ...
        {
            at.transform.GetChild(0).gameObject.transform.localScale += new Vector3(0.4f, 0, 0.4f) * Time.deltaTime*2f;
        }
        else
        {
